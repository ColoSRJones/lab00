...
let allProducts = []; //Changed const to let because of error
const container = document.getElementById('image_container');
const viewed = [];
const labels = [];
const pics = [leftImage, centerImage, rightImage];
const list = document.getElementById('productlist');
let totalClicks = 0; //Changed const to let because of error
const views = [];
const votes = [];
...
function displayPics() {
	...
	//  I replaced all 'var' to 'let'. After that, I replaced all 'let' to 'const'. Only two errors show up for 'allProducts' and 'totalClicks'. I changed 'const' to 'let'. Both changed and no errors.
	// Also console.log(rando) was show up as error. Have to move console.log(rando) moved to line 34 from line 38. 
